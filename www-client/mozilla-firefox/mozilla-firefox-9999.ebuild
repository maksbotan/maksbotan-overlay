...
inherit flag-o-matic toolchain-funcs eutils mozconfig-3 makeedit multilib pax-utils fdo-mime autotools mercurial
...
IUSE="${IUSE_INTERNAL} +alsa bindist java mozdevelop +safebrowsing spell libnotify"
...
RDEPEND=">=sys-devel/binutils-2.16.1
	...
	!internal_sqlite? ( >=dev-db/sqlite-3.6.20-r1[fts3] )
	!!www-client/${PN}-bin"
